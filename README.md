...
You may also **[download WSBEditor onto your device](https://leesteve.tk/WSBEditor/releases/WSBEditor-0.1.0.zip)**.  This is particularly useful if you want to use WSBEditor while you go offline.
